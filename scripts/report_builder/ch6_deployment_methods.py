...
from .config import (
    add_styled_heading, add_body_p, add_bullet_p, add_code_block, add_figure_with_notes
)
...
"joblib.dump(full_pipeline, 'models/ecommerce/ecommerce_pipeline.joblib')"
    ...
    add_body_p(doc, "Toàn bộ 3 pipeline mô hình được nạp sẵn vào bộ nhớ RAM ngay tại thời điểm khởi động máy chủ thông qua Lifespan Context Manager, giúp loại bỏ độ trễ nạp đĩa (Disk I/O Latency) và bảo đảm thời gian phản hồi mỗi request dưới 10 mili-giây.")
